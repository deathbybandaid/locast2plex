...
from m3u8.protocol import ext_x_key, ext_x_map, ext_x_session_key, ext_x_start
...
class Segment(BasePathMixin):
    ...
    def __init__(self, uri=None, base_uri=None, program_date_time=None, current_program_date_time=None,
        ...
        self.key = keyobject
        self.parts = PartialSegmentList([PartialSegment(base_uri=self.base_uri, **partial)
                                         for partial in parts] if parts else [])
